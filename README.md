...
The display emulates what is shown on the Tillerpilot screen, and only supports the two primary modes: Standby and Auto. There are additional communications status indicators.
...
* WIFI signal strength is shown in light blue in the left-center of the status area. The bars are the same height, from zero to five bars.
