...
* WIFI signal strength is shown in light blue in the left-center of the status area. The bars are the same height, from 0 to 5, with 0 = none, 1 = very weak to 5 = excellent. Ideally you'll see at least 2 bars.
